                    ...
                    <div class="col-md-4 text-center">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <form id="logoForm" action="../php/Profil/slogo.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-8">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <form action="../php/Profil/simpan.php" method="POST" require>
                            <div class="form-group">
                              <label>Nama Sekolah</label>
                              <input type="text" class="form-control" name="nama_sekolah" require>
                            </div>
                            <div class="form-group">
                              <label>Nama Kepala Sekolah</label>
                              <input type="text" class="form-control" name="namakp_sekolah" require>
                            </div>
                            <div class="form-group">
                              <label>NIP Kepala Sekolah</label>
                              <input type="number" class="form-control" name="nipkp" require>
                            </div>
                            <div class="form-group">
                              <label>Alamat Kantor Sekolah</label>
                              <input type="text" class="form-control" name="alamat_sekolah" require>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="number" class="form-control" name="noponsel" require>
                            </div>
