                            ...
                            <div class="card">
                                <div class="container mt-4">
                                    ...
                                    <div class="col-md-8">
                                        <div class="card">
                                            <div class="card-body">
                                                <button class="btn btn-outline-primary mb-3" onclick="location.href='Kelas.php'">
                                                    <i class="ti-arrow-left"></i> Kembali Ke Daftar Kelas
                                                </button>
                                                <form action="../php/Jadwal/skelas.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="text-right mt-4">
                                                        <button type="button" class="btn btn-danger" onclick="location.href='Kelas.php'"><i class="ti-close"></i> Batal</button>
