                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="add_kelas.php" class="btn btn-outline-primary btn-icon-text btn-fw" style="margin-bottom: 10px;">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        $query = "SELECT * FROM kelas"; // Sesuaikan dengan tabel Anda
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
                window.location.href = `../php/Jadwal/dkelas.php?id=${id}`;
            }
        }
    </script>
