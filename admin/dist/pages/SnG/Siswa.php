            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="add_siswa.php" class="btn btn-outline-primary btn-icon-text btn-fw" style="margin-bottom: 10px;">
                    <i class="ti-pencil-alt btn-icon-prepend" style="margin-right: 5px;"></i> tambah Siswa
                  </a>
                  <div class="table-responsive">
                    ...
                    $query = "SELECT * FROM siswa"; // Sesuaikan dengan tabel Anda
                      ...
                      <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          while ($row = mysqli_fetch_assoc($result)) {
                            // Pastikan bahwa atribut foto_siswa memiliki data yang valid
                            $fotoPath = "../uploads/Foto_siswa/" . (!empty($row['foto_siswa']) ? $row['foto_siswa'] : 'default.jpg'); // Gunakan default.jpg jika foto tidak ditemukan
                          ?>
                            <tr>
                              <td>
                                <a href="../uploads/Foto_siswa/<?php echo htmlspecialchars($row['foto_siswa']); ?>" target="_blank">
                                  <img src="<?php echo htmlspecialchars($fotoPath); ?>"
                                    alt="Foto Siswa <?php echo htmlspecialchars($row['id_siswa']); ?>"
                              ...
                              <td><?php echo htmlspecialchars($row['tgll_siswa']); ?></td>
                              <td><?php echo htmlspecialchars($row['alamat']); ?></td>
                              <td><?php echo htmlspecialchars($row['nohp_ortu']); ?></td>
                              <td>
                                <!-- Tombol Ubah -->
                                <a href="edit_siswa.php?id_siswa=<?php echo htmlspecialchars($row['id_siswa']); ?>"
                                  class="btn btn-warning btn-sm">Ubah</a>
                                <!-- Tombol Hapus -->
                                <button onclick="confirmDelete(<?php echo htmlspecialchars($row['id_siswa']); ?>)"
  ...
  <script>
    function confirmDelete(id) {
      if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
        window.location.href = `../php/SnG/dsiswa.php?id_siswa=${id}`;
      }
    }
  </script>
