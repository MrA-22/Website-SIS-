                    ...
                    <div class="col-md-4 text-center">
                      <div class="card">
                        <div class="card-body">
                          ...
                          if (!empty($nis)) {
                            $query = "SELECT foto_siswa FROM siswa WHERE nisn/nis = '$nisn'"; // Sesuaikan nama tabel dan kolom
                          ...
                          ?>
                          <!-- Menampilkan gambar -->
                          <img src="<?php echo $fotoPath; ?>" alt="Foto Siswa" style="width: 100%; max-height: 600px; object-fit: cover;">
                          <h5 class="mt-3">Foto Siswa</h5>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="card">
                        <div class="card-body">
                          <button class="btn btn-outline-primary mb-3" onclick="location.href='Siswa.php'">
                            <i class="ti-arrow-left"></i> Kembali Ke Data Identitas Siswa
                          </button>
                          <form action="../php/SnG/sgambar.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <input type="date" class="form-control" name="tgll_siswa" required>
                            </div>
                            <div class="form-group">
                              <label>Kelas</label>
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="nohp_ortu" required>
                            </div>
