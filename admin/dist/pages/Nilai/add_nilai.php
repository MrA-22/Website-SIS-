                                ...
                                <div class="container mt-5">
                                    ...
                                    <form method="GET" action="">
                                        <select name="kelas" id="kelas" class="form-control" required>
                                            ...
                                            <?php
                                            // Ambil daftar nama kelas dari database
                                            $queryKelas = "SELECT DISTINCT kelas FROM siswa ORDER BY kelas";
                                    ...
                                    <div class="mt-4">
                                        ...
                                        if (isset($_GET['kelas']) && !empty($_GET['kelas'])) {
                                            ...
                                            $querySiswa = "SELECT * FROM siswa WHERE kelas = '$kelasId' ORDER BY nama_siswa";
                                            $resultSiswa = mysqli_query($koneksi, $querySiswa);

                                            if (mysqli_num_rows($resultSiswa) > 0) {
                                                echo "<form method='POST' action='tambah_nilai.php'>
                                                ...
                                                while ($row = mysqli_fetch_assoc($resultSiswa)) {
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <select name='mata_pelajaran[{$row['id_siswa']}]' class='form-control' required>
                                                    ...
                                                    while ($mapel = mysqli_fetch_assoc($resultMapel)) {
                                                        echo "<option value='{$mapel['mapel']}'>{$mapel['mapel']}</option>";
                                                    }
                                                    echo "</select>
                                                        </td>
                                                        <td><input type='number' name='nilai[{$row['id_siswa']}]' class='form-control' required></td>
                                                    </tr>";
                                                }
                                                echo "</tbody></table>
                                                ...
                                                echo "<p>Tidak ada siswa yang ditemukan di kelas ini.</p>";
                                            }
                                        }
                                        ?>
                                    </div>
