                            ...
                            <div class="col-md-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="container mt-4">
                                        <h3 class="card-title" style="font-size: 1.2em; text-transform: uppercase; font-weight: bold;">Identitas Guru</h3>
                                        <!-- Bagian Logo Desa -->
                                        <div class="row">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        if (!empty($nis)) {
                                                            ...
                                                            if (mysqli_num_rows($result) > 0) {
                                                                ...
                                                                $fotoPath = "../uploads/Foto_guru/default.jpg"; // Gambar default jika siswa tidak ditemukan
                                                            }
                                                        } else {
                                                        ...
                                                        ?>
                                                        <!-- Menampilkan gambar -->
                                                        <img src="<?php echo $fotoPath; ?>" alt="Foto guru" style="width: 100%; max-height: 600px; object-fit: cover;">
                                                        <h5 class="mt-3">Foto Guru</h5>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <button class="btn btn-outline-primary mb-3" onclick="location.href='Guru.php'">
                                                            <i class="ti-arrow-left"></i> Kembali Ke Data Guru
                                                        </button>
                                                        <form action="../php/SnG/sggambar.php" method="POST" enctype="multipart/form-data">
                                                            <div class="form-group">
                                                                <label for="fotoInput">Unggah Foto</label>
                                                                <input type="file" class="form-control mt-2" name="foto" id="fotoInput" required>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" class="form-control" name="tgll_guru" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Mata Pelajaran</label>
                                                                <input type="text" class="form-control" name="mengajar" required>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Alamat</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label>Nomor Ponsel Guru</label>
                                                                <input type="number" class="form-control" name="nohp_guru" required>
                                                            </div>
                                                            <!-- Tambahkan input lain sesuai kebutuhan -->
                                                            <div class="text-right mt-4">
                                                                <button type="button" class="btn btn-danger" onclick="location.href='Guru.php'"><i class="ti-close"></i> Batal</button>
                                                                <button type="submit" class="btn btn-success"><i class="ti-check"></i> Simpan</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
