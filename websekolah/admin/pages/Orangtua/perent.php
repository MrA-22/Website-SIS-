                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        $query = "SELECT * FROM orang_tua"; // Sesuaikan dengan tabel Anda
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($result)) {?>
                                                            ...
                                                            <td><?php echo htmlspecialchars($row['sandi']); ?></td>
                                                            <td>
                                                                <!-- Tombol Ubah -->
                                                                <a href="edit_orangtua.php?id=<?php echo htmlspecialchars($row['id']); ?>"
