                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="add_mapel.php" class="btn btn-outline-primary btn-icon-text btn-fw" style="margin-bottom: 10px;">
                                        <i class="ti-pencil-alt btn-icon-prepend" style="margin-right: 5px;"></i> Tambah Mapel
                                    </a>
                                    <a href="Jadwal.php" class="btn btn-outline-primary btn-icon-text btn-fw" style="margin-bottom: 10px;">
                                        <i class="ti-arrow-left" style="margin-right: 5px;"></i> Kembali ke Jadwal
                                    </a>
                                    <div class="table-responsive">
                                        ...
                                        $query = "SELECT * FROM mapel"; // Sesuaikan dengan tabel Anda
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <!-- Tombol Hapus -->
                                                                <button onclick="confirmDelete(<?php echo htmlspecialchars($row['id_mapel']); ?>)"
    ...
    <script>
        function confirmDelete(id) {
            if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
                window.location.href = `../php/Jadwal/dmapel.php?id_mapel=${id}`;
            }
        }
    </script>
