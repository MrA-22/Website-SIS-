                        ...
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="container mt-4">
                                    <h3 class="card-title">Taambah Mata Pelajaran</h3>
                                    <!-- Bagian Form Identitas siswa -->
                                    <div class="col-md-8">
                                        <div class="card">
                                            <div class="card-body">
                                                <button class="btn btn-outline-primary mb-3" onclick="location.href='Mapel.php'">
                                                    <i class="ti-arrow-left"></i> Kembali Ke Mata Pelajaran
                                                </button>
                                                <form action="../php/Jadwal/smapel.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="text-right mt-4">
                                                        <button type="button" class="btn btn-danger" onclick="location.href='Mapel.php'"><i class="ti-close"></i> Batal</button>
