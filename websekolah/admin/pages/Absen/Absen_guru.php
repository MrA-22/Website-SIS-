...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $querySiswa = "SELECT nama_siswa, kelas_id FROM siswa WHERE id = '$id_siswa'";
    ...
    // Simpan data absensi
    $queryInsert = "INSERT INTO absensi (id_siswa, nama_siswa, kelas_id, tanggal, status, keterangan)
                    VALUES ('$id_siswa', '$nama_siswa', '$kelas_id', '$tanggal', '$status', '$keterangan')";
